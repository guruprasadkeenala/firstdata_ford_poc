...
function clickMe(input){
	var iframe = document.getElementById('fdFrame');
	...
	iframe.src = "http://localhost:8080/fd/fdhome.jsp?reqPage="+requested_page;
}
</script>
</head>
<body>
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <!-- Button trigger modal -->
			  ...
			  <iframe id="fdFrame"width="100%" height="600" frameborder="0">
              </iframe>
          </div>
        </div>
    </section>
