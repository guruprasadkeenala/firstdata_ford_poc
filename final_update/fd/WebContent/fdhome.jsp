	                      ...
	                      <div class="row">
	                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                          ...
	                          <form>
	                            ...
	                            <button type="Button" id="addCard" class="btn btn-primary mb20" title="Add Card">Add Card</button>
	                          </form>
	                        </div>
	                      </div>
	                    </div>
	                      ...
	                      <div class="row">
	                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	                          ...
	                          <form>
	                            ...
	                            <button type="Button" id="guestUser" class="btn btn-primary mb20" title="Review Order">Review Order</button>
	                          </form>
	                        </div>
	                      </div>
	                    </div>
